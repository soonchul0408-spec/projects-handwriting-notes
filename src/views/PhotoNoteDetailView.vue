...
const note = computed(() => noteLibrary.find((item) => item.id === route.params.noteId))
...
<template>
  <div class="photo-detail-shell">
    ...
    <main v-if="note" class="photo-detail-main page-width">
