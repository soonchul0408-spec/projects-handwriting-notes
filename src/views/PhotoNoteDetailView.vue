...
<template>
  <div class="photo-detail-shell">
    <header class="photo-detail-topbar page-width">
      ...
      <nav class="photo-detail-nav" aria-label="노트 메뉴"><a href="/notes">내 노트</a><a href="/concepts">핵심 단어</a><a href="/metrics">수치 그래프</a><a href="/#how-it-works">사용 방법</a></nav>
...
@media (max-width: 680px) { .page-width, .photo-detail-main { width: min(100% - 36px, 520px); }.photo-detail-topbar { min-height: 72px; flex-wrap: wrap; gap: 13px; padding: 14px 0 10px; }.photo-detail-nav { order: 3; width: 100%; justify-content: space-between; gap: 8px; margin: 0; overflow-x: auto; font-size: 9px; }.photo-detail-main { padding-top: 49px; }.photo-detail-heading h1 { font-size: 35px; }.detail-summary { grid-template-columns: 1fr; gap: 18px; padding: 29px 26px; }.organized-section { grid-template-columns: 32px 1fr; gap: 8px; padding: 25px 20px; }.uncertain-section { grid-template-columns: 1fr; gap: 13px; padding: 21px; }.related-list { grid-template-columns: 1fr; }.photo-detail-footer { align-items: flex-start; gap: 20px; }.photo-detail-footer > span:last-child { text-align: right; } }
</style>
